...
pid_DA_0->GetXaxis()->CenterTitle();
pid_DA_0->GetYaxis()->CenterTitle();
...
//	}
	...
	for (int i = 0; i < si2->size(); i++){
		...
		for (int j=0; j < si2->size(); j++){
			...
			if (si2->at(i).sectorStr=="DA" && si2->at(j).sectorStr=="DA" && i!=j && used0 == 0){
				if (si2->at(i).dE != 0 && si2->at(j).E1 !=0 && si2->at(i).PstripdE == si2->at(j).PstripE1){
					DA_PIDhists[si2->at(i).PstripdE]->Fill(si2->at(j).E1,si2->at(i).dE);
					usedEvt0.push_back(i);
					usedEvt0.push_back(j);
				}
				if (si2->at(i).E1 != 0 && si2->at(j).dE !=0 && si2->at(i).PstripE1 == si2->at(j).PstripdE){
					DA_PIDhists[si2->at(j).PstripdE]->Fill(si2->at(i).E1,si2->at(j).dE);
					usedEvt0.push_back(i);
					usedEvt0.push_back(j);
				}
			}
			...
			if (si2->at(i).sectorStr=="DA" && si2->at(j).sectorStr=="DA" && i!=j && used1 == 0){
			...
			if (si2->at(i).sectorStr=="DA" && si2->at(j).sectorStr=="DA" && i!=j && used2 == 0){
			...
			if (si2->at(i).sectorStr=="DA" && si2->at(j).sectorStr=="DA" && i!=j && used3 == 0){
			...
			if (si2->at(i).sectorStr=="DA" && si2->at(j).sectorStr=="DA" && i!=j && used4 == 0){
